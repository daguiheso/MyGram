...
function compile(watch) {
	...
	function rebundle() {
		bundle
			.transform(babel, { presets: ['es2015'], plugins: ['syntax-async-functions', 'transform-regenerator'] })  /*que lo transforme utilizando babel - sin esta linea no utilizariamos ecma6*/
